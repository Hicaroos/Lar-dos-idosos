...
/**
* @see \App\Http\Controllers\ResidentsController::destroyPhoto
* @see app/Http/Controllers/ResidentsController.php:91
* @route '/residents/{resident}/photo'
*/
export const destroyPhoto = (args: { resident: string | number | { id: string | number } } | [resident: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/residents/{resident}/photo'
*/
destroyPhoto.url = (args: { resident: string | number | { id: string | number } } | [resident: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { resident: args }
    }
...
* @route '/residents/{resident}/photo'
*/
destroyPhoto.delete = (args: { resident: string | number | { id: string | number } } | [resident: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyPhoto.url(args, options),
    method: 'delete',
})
...
* @route '/residents/{resident}/photo'
*/
const destroyPhotoForm = (args: { resident: string | number | { id: string | number } } | [resident: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/residents/{resident}/photo'
*/
destroyPhotoForm.delete = (args: { resident: string | number | { id: string | number } } | [resident: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destroyPhoto.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const ResidentsController = { restore, forceDelete, destroyPhoto, index, create, store, show, edit, update, destroy }
