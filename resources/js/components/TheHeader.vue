...
<template>
    <header
        ...
        <nav class="flex items-center gap-1 bg-slate-100/80 p-1.5 rounded-full border border-slate-200/50">
            <Link href="/residents"
                :class="[$page.url === '/residents' || !$page.url.includes('status=history') ? 'bg-white text-emerald-700 shadow-sm ring-1 ring-slate-900/5' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-200/50']"
            ...
            <Link href="/residents?status=history"
                :class="[$page.url.includes('status=history') ? 'bg-white text-emerald-700 shadow-sm ring-1 ring-slate-900/5' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-200/50']"
